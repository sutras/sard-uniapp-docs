import{u as a}from"./useCodeTool-bcffc59d.js";import{d as s,c as n,o as t}from"./index-28a3fb09.js";const p=`<h1 id="ProgressBar条形进度条">ProgressBar 条形进度条<a class="doc-anchor" href="#ProgressBar条形进度条">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>以横条的方式展示当前进度。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> ProgressBar <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/progress-bar/progress-bar.vue'</span>
</code></pre></div>
