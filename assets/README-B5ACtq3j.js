...
</div><h3 id="自定义格式">自定义格式<a class="doc-anchor" href="#自定义格式">#</a></h3>
...
</div><h3 id="毫秒级别的渲染">毫秒级别的渲染<a class="doc-anchor" href="#毫秒级别的渲染">#</a></h3>
...
</div><h3 id="手动控制">手动控制<a class="doc-anchor" href="#手动控制">#</a></h3>
...
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-count-down</span>
    ...
    <span class="token attr-name">@finish</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>toast('到时了!')<span class="token punctuation">"</span></span>
  <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>

<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">setup</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>ts<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
<span class="token keyword">import</span> <span class="token punctuation">&#123;</span> ref <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'vue'</span>
<span class="token keyword">import</span> <span class="token punctuation">&#123;</span> toast<span class="token punctuation">,</span> type CountDownExpose <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'sard-uniapp'</span>
...
</div><h3 id="验证码倒计时">验证码倒计时<a class="doc-anchor" href="#验证码倒计时">#</a></h3>
<p>下面代码演示了获取验证码场景中倒计时配合按钮的使用。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</table></div><h3 id="CountDownSlots">CountDownSlots<a class="doc-anchor" href="#CountDownSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="CountDownEmits">CountDownEmits<a class="doc-anchor" href="#CountDownEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div><h3 id="CountDownExpose">CountDownExpose<a class="doc-anchor" href="#CountDownExpose">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>属性</th>
<th>描述</th>
...
</table></div><h3 id="CountDownCurrentTime">CountDownCurrentTime<a class="doc-anchor" href="#CountDownCurrentTime">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>属性</th>
<th>描述</th>
...
</table></div>`,i=s({__name:"README",setup(c){const a={nav:"组件",title:"CountDown",subtitle:"倒计时",group:"数据展示"};return(e,l)=>(p(),t(n,{content:o,fm:a}))}});export{i as default};
