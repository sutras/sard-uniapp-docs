import{u as a}from"./useCodeTool-bcffc59d.js";import{d as s,c as n,o as t}from"./index-28a3fb09.js";const p=`<h1 id="Dropdown下拉菜单">Dropdown 下拉菜单<a class="doc-anchor" href="#Dropdown下拉菜单">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>可向下/向上弹出菜单列表，或自定义弹出的菜单内容。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Dropdown <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/dropdown/dropdown.vue'</span>
<span class="token keyword">import</span> DropdownItem <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/dropdown-item/dropdown-item.vue'</span>
</code></pre></div>
