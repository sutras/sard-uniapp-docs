import{u as a}from"./useCodeTool-bcffc59d.js";import{d as s,c as n,o as t}from"./index-28a3fb09.js";const p=`<h1 id="PasswordInput密码输入框">PasswordInput 密码输入框<a class="doc-anchor" href="#PasswordInput密码输入框">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>用于输入密码、验证码等场景可结合数字键盘组件或原生键盘使用。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> PasswordInput <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/password-input/password-input.vue'</span>
</code></pre></div>
