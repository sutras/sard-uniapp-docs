...
</div><h3 id="最大值">最大值<a class="doc-anchor" href="#最大值">#</a></h3>
...
</div><h3 id="值为0时不隐藏">值为 0 时不隐藏<a class="doc-anchor" href="#值为0时不隐藏">#</a></h3>
...
</div><h3 id="圆点显示">圆点显示<a class="doc-anchor" href="#圆点显示">#</a></h3>
...
</div><h3 id="独立展示">独立展示<a class="doc-anchor" href="#独立展示">#</a></h3>
...
</div><h3 id="不包裹组件">不包裹组件<a class="doc-anchor" href="#不包裹组件">#</a></h3>
...
</table></div><h3 id="BadgeSlots">BadgeSlots<a class="doc-anchor" href="#BadgeSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</div>`,d=n({__name:"README",setup(c){const a={nav:"组件",title:"Badge",subtitle:"徽标",group:"数据展示"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{d as default};
