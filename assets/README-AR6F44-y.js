import{u as s}from"./useCodeTool-BHI87-YZ.js";import{d as a,c as n,o as t}from"./index-DRgrUBxf.js";const p=`<h1 id="Fab悬浮按钮sup15sup">Fab 悬浮按钮 <sup>1.5+</sup><a class="doc-anchor" href="#Fab悬浮按钮sup15sup">#</a></h1>
...
<h3 id="修改背景色">修改背景色<a class="doc-anchor" href="#修改背景色">#</a></h3>
...
<h3 id="隐藏按钮名称">隐藏按钮名称<a class="doc-anchor" href="#隐藏按钮名称">#</a></h3>
...
<h3 id="左上角显示">左上角显示<a class="doc-anchor" href="#左上角显示">#</a></h3>
<p>按钮默认显示在右下角，设置 <code>left</code> 或 <code>top</code> 可以让其显示在左上角。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-fab</span> <span class="token attr-name">:item-list</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>itemList<span class="token punctuation">"</span></span> <span class="token attr-name">top</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>96rpx<span class="token punctuation">"</span></span> <span class="token attr-name">left</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>48rpx<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
...
<h3 id="右上角显示">右上角显示<a class="doc-anchor" href="#右上角显示">#</a></h3>
<p>按钮默认显示在右下角，设置 <code>top</code> 会将其从底部显示在顶部。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-fab</span> <span class="token attr-name">:item-list</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>itemList<span class="token punctuation">"</span></span> <span class="token attr-name">top</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>96rpx<span class="token punctuation">"</span></span> <span class="token attr-name">right</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>48rpx<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
...
<h3 id="左下角显示">左下角显示<a class="doc-anchor" href="#左下角显示">#</a></h3>
...
<h3 id="无扩展按钮显示">无扩展按钮显示<a class="doc-anchor" href="#无扩展按钮显示">#</a></h3>
...
<h3 id="FabSlots">FabSlots<a class="doc-anchor" href="#FabSlots">#</a></h3>
<div class="doc-table-responsive"><table>
<thead>
<tr>
<th>插槽</th>
...
<h3 id="FabEmits">FabEmits<a class="doc-anchor" href="#FabEmits">#</a></h3>
<div class="doc-table-responsive"><table>
<thead>
<tr>
<th>事件</th>
...
<h3 id="FabItem">FabItem<a class="doc-anchor" href="#FabItem">#</a></h3>
<div class="doc-table-responsive"><table>
<thead>
<tr>
<th>属性</th>
...
<div class="doc-code-wrapper"><pre class="language-scss"><code class="language-scss"><span class="token selector">page </span><span class="token punctuation">&#123;</span>
  ...
  <span class="token property">--sar-fab-item-btn-shadow</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--sar-shadow-lg<span class="token punctuation">)</span><span class="token punctuation">;</span>
