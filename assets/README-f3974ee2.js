import{u as a}from"./useCodeTool-5abdc725.js";import{d as s,c as n,o as t}from"./index-da6ae011.js";const p=`<h1 id="Grid宫格">Grid 宫格<a class="doc-anchor" href="#Grid宫格">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>将多个类目进行等宽排列，用于内容展示或者页面导航。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Grid <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/grid/grid.vue'</span>
<span class="token keyword">import</span> GridItem <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/grid-item/grid-item.vue'</span>
</code></pre></div>
