import{u as a}from"./useCodeTool-5abdc725.js";import{d as n,c as s,o as t}from"./index-da6ae011.js";const p=`<h1 id="Form表单">Form 表单<a class="doc-anchor" href="#Form表单">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>用于数据采集，由各种类型的表单域组成，可对数据进行校验、清除、重置、提交等操作。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Form <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/form/form.vue'</span>
<span class="token keyword">import</span> FormItem <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/form-item/form-item.vue'</span>
</code></pre></div>
