...
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Keyboard <span class="token keyword">from</span> <span class="token string">'sard-uniapp/components/keyboard/keyboard.vue'</span>
</code></pre>
...
</div><h3 id="带小数点的数字键盘">带小数点的数字键盘<a class="doc-anchor" href="#带小数点的数字键盘">#</a></h3>
<p>允许输入小数。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="身份证键盘">身份证键盘<a class="doc-anchor" href="#身份证键盘">#</a></h3>
<p>由 0-9 和 X 组成。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="随机数字键盘">随机数字键盘<a class="doc-anchor" href="#随机数字键盘">#</a></h3>
<p>展示乱序的数字按键。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="车牌号键盘">车牌号键盘<a class="doc-anchor" href="#车牌号键盘">#</a></h3>
<p>用于输入车牌号。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</table></div><h3 id="KeyboardEmits">KeyboardEmits<a class="doc-anchor" href="#KeyboardEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div><h3 id="KeyBoardExpose">KeyBoardExpose<a class="doc-anchor" href="#KeyBoardExpose">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>属性</th>
<th>描述</th>
...
<div class="doc-code-wrapper"><pre class="language-scss"><code class="language-scss"><span class="token keyword">@include</span> <span class="token selector">theme-dark </span><span class="token punctuation">&#123;</span>
  ...
  <span class="token property">--sar-keyboard-key-color</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--sar-white<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">--sar-keyboard-key-bg</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--sar-gray-600<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token property">--sar-keyboard-key-active-bg</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--sar-gray-500<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</div>`,k=n({__name:"README",setup(e){const a={nav:"组件",title:"Keyboard",subtitle:"键盘",group:"表单组件"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{k as default};
