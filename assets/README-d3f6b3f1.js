import{u as a}from"./useCodeTool-5abdc725.js";import{d as s,c as t,o as n}from"./index-da6ae011.js";const p=`<h1 id="PopoutInput弹出层输入框">PopoutInput 弹出层输入框<a class="doc-anchor" href="#PopoutInput弹出层输入框">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>输入框组件，用于配合弹出框组件和表单控件一起使用。自定义了输入框样式。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> PopoutInput <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/popout-input/popout-input.vue'</span>
</code></pre></div>
...
`,r=s({__name:"README",setup(o){return a(),(e,c)=>(n(),t("div",{class:"doc-content",innerHTML:p}))}});export{r as default};
