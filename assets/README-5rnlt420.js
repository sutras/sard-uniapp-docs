...
.sar-portal `),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token property"},"--sar-share-sheet-item-description-color"),n("span",{class:"token punctuation"},":"),s(),n("span",{class:"token function"},"var"),n("span",{class:"token punctuation"},"("),s("--sar-fourth-color"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),s(`
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1)])),_:1})]),_:1})}const g=c(k,[["render",i]]);export{g as default};
