...
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Input <span class="token keyword">from</span> <span class="token string">'sard-uniapp/components/input/input.vue'</span>
</code></pre>
...
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>view</span> <span class="token special-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token value css language-css"><span class="token property">padding</span><span class="token punctuation">:</span> 10rpx 20rpx<span class="token punctuation">;</span> <span class="token property">background</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--sar-gray-400<span class="token punctuation">)</span></span><span class="token punctuation">"</span></span></span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-input</span>
      ...
      <span class="token attr-name">placeholder-style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>color: rgba(0,0,0,.3)<span class="token punctuation">"</span></span>
...
</div><h3 id="可清除的">可清除的<a class="doc-anchor" href="#可清除的">#</a></h3>
...
</div><h3 id="聚焦时显示清除按钮">聚焦时显示清除按钮<a class="doc-anchor" href="#聚焦时显示清除按钮">#</a></h3>
...
</div><h3 id="去除边框">去除边框<a class="doc-anchor" href="#去除边框">#</a></h3>
<p>清除边框后页面看起来会很清爽。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="嵌入的">嵌入的<a class="doc-anchor" href="#嵌入的">#</a></h3>
...
</div><h3 id="多行文本">多行文本<a class="doc-anchor" href="#多行文本">#</a></h3>
...
</div><h3 id="自动高度">自动高度<a class="doc-anchor" href="#自动高度">#</a></h3>
...
</div><h3 id="字数提示">字数提示<a class="doc-anchor" href="#字数提示">#</a></h3>
...
</table></div><h3 id="InputSlots">InputSlots<a class="doc-anchor" href="#InputSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="InputEmits">InputEmits<a class="doc-anchor" href="#InputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
.sar-portal </span><span class="token punctuation">&#123;</span>
  ...
  <span class="token property">--sar-input-control-line-height</span><span class="token punctuation">:</span> <span class="token function">var</span><span class="token punctuation">(</span>--sar-leading-normal<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</div>`,d=s({__name:"README",setup(e){const a={nav:"组件",title:"Input",subtitle:"输入框",group:"表单组件"};return(c,l)=>(p(),t(n,{content:o,fm:a}))}});export{d as default};
