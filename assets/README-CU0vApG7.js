...
</div><h3 id="内部文本">内部文本<a class="doc-anchor" href="#内部文本">#</a></h3>
...
</div><h3 id="隐藏文本">隐藏文本<a class="doc-anchor" href="#隐藏文本">#</a></h3>
...
</table></div><h3 id="ProgressBarSlots">ProgressBarSlots<a class="doc-anchor" href="#ProgressBarSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</div>`,k=n({__name:"README",setup(e){const a={nav:"组件",title:"ProgressBar",subtitle:"条形进度条",group:"数据展示"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{k as default};
