...
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Popup <span class="token keyword">from</span> <span class="token string">'sard-uniapp/components/popup/popup.vue'</span>
</code></pre>
...
<span class="token atrule"><span class="token rule">@import</span> <span class="token string">'@/style/index.scss'</span><span class="token punctuation">;</span></span>
...
</table></div><h3 id="PopupSlots">PopupSlots<a class="doc-anchor" href="#PopupSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="PopupEmits">PopupEmits<a class="doc-anchor" href="#PopupEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,r=n({__name:"README",setup(e){const a={nav:"组件",title:"Popup",subtitle:"弹出层",group:"数据展示"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{r as default};
