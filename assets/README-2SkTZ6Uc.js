...
</div><h3 id="自定义列数">自定义列数<a class="doc-anchor" href="#自定义列数">#</a></h3>
...
</div><h3 id="正方形格子">正方形格子<a class="doc-anchor" href="#正方形格子">#</a></h3>
...
</div><h3 id="格子间距">格子间距<a class="doc-anchor" href="#格子间距">#</a></h3>
...
</div><h3 id="显示边框">显示边框<a class="doc-anchor" href="#显示边框">#</a></h3>
<p>显示边框后看起来分割更明显。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="内容横排">内容横排<a class="doc-anchor" href="#内容横排">#</a></h3>
...
</div><h3 id="内容翻转">内容翻转<a class="doc-anchor" href="#内容翻转">#</a></h3>
<p>将文本和图标的位置调换。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="徽标提示">徽标提示<a class="doc-anchor" href="#徽标提示">#</a></h3>
<p>添加点击态。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-grid</span> <span class="token attr-name">:columns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>2<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-grid-item</span> <span class="token attr-name">text</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>文字<span class="token punctuation">"</span></span> <span class="token attr-name">icon</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>image<span class="token punctuation">"</span></span> <span class="token attr-name">dot</span> <span class="token punctuation">/></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-grid-item</span> <span class="token attr-name">text</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>文字<span class="token punctuation">"</span></span> <span class="token attr-name">icon</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>image<span class="token punctuation">"</span></span> <span class="token attr-name">:badge</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>999<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>sar-grid</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre>
...
</table></div><h3 id="GridSlots">GridSlots<a class="doc-anchor" href="#GridSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="GridItemProps">GridItemProps<a class="doc-anchor" href="#GridItemProps">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>属性</th>
<th>描述</th>
...
<tr>
<td>dot <sup>1.12+</sup></td>
<td>是否显示宫格项右上角小红点</td>
<td>boolean</td>
<td>false</td>
</tr>
<tr>
<td>badge <sup>1.12+</sup></td>
<td>宫格项右上角徽标的内容</td>
<td>number | string</td>
<td>-</td>
</tr>
<tr>
<td>badge-props <sup>1.12+</sup></td>
<td>自定义徽标属性</td>
<td><a href="./badge#BadgeProps">BadgeProps</a></td>
<td>-</td>
</tr>
</tbody>
</table></div><h3 id="GridItemSlots">GridItemSlots<a class="doc-anchor" href="#GridItemSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="GridItemEmits">GridItemEmits<a class="doc-anchor" href="#GridItemEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,i=n({__name:"README",setup(c){const a={nav:"组件",title:"Grid",subtitle:"宫格",group:{title:"布局",order:1}};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{i as default};
