...
</table></div>`,k=n({__name:"README",setup(c){const a={nav:"组件",title:"Qrcode",subtitle:"二维码",group:"数据展示",version:"1.4+"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{k as default};
