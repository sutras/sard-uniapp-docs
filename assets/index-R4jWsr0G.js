import { g as getDefaultExportFromCjs, a as onMounted, d as defineComponent, _ as _export_sfc, o as openBlock, b as createElementBlock, e as createBaseVNode, f as createTextVNode, t as toDisplayString, h as createCommentVNode } from "./index-BQ9n9zQO.js";
...
function generateTool(wrapper) {
  ...
  const clipboard2 = new Clipboard(button, {
...
function destroyTool(wrapper) {
  const button = wrapper.querySelector(".doc-copy");
  if (button) {
    button.remove();
  }
}
function useCodeTool() {
  onMounted(() => {
    const allWrapper = Array.from(document.querySelectorAll(".doc-code-wrapper"));
...
const _hoisted_1 = { class: "doc-content" };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("h1", null, [
      createTextVNode(
        toDisplayString(_ctx.fm.title) + " " + toDisplayString(_ctx.fm.subtitle) + " ",
        1
        /* TEXT */
      ),
      _ctx.fm.version ? (openBlock(), createElementBlock(
        "sup",
        _hoisted_2,
        toDisplayString(_ctx.fm.version),
        1
        /* TEXT */
      )) : createCommentVNode("v-if", true)
    ]),
    createBaseVNode("div", { innerHTML: _ctx.content }, null, 8, _hoisted_3)
  ]);
}
const Markdown = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  Markdown as M
};
