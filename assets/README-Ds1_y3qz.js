...
</div><h3 id="显示标题">显示标题<a class="doc-anchor" href="#显示标题">#</a></h3>
...
</div><h3 id="显示头像">显示头像<a class="doc-anchor" href="#显示头像">#</a></h3>
...
</div><h3 id="圆形头像">圆形头像<a class="doc-anchor" href="#圆形头像">#</a></h3>
...
</div><h3 id="圆角标题和段落">圆角标题和段落<a class="doc-anchor" href="#圆角标题和段落">#</a></h3>
...
</div><h3 id="动画效果">动画效果<a class="doc-anchor" href="#动画效果">#</a></h3>
...
</div><h3 id="包含子组件">包含子组件<a class="doc-anchor" href="#包含子组件">#</a></h3>
...
</table></div><h3 id="SkeletonBlockProps">SkeletonBlockProps<a class="doc-anchor" href="#SkeletonBlockProps">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>属性</th>
<th>描述</th>
...
</table></div><h3 id="SkeletonAvatarProps">SkeletonAvatarProps<a class="doc-anchor" href="#SkeletonAvatarProps">#</a></h3>
...
</table></div><h3 id="SkeletonTitleProps">SkeletonTitleProps<a class="doc-anchor" href="#SkeletonTitleProps">#</a></h3>
...
</div>`,r=n({__name:"README",setup(e){const a={nav:"组件",title:"Skeleton",subtitle:"骨架屏",group:"反馈组件"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{r as default};
