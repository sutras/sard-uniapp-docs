import{u as a}from"./useCodeTool-bcffc59d.js";import{d as n,c as s,o as t}from"./index-28a3fb09.js";const p=`<h1 id="Pagination分页">Pagination 分页<a class="doc-anchor" href="#Pagination分页">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>用于分割长列表，每次加载一页数据。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Pagination <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/pagination/pagination.vue'</span>
</code></pre></div>
