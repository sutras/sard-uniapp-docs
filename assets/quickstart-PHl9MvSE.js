import{M as a}from"./index-BYbW3z8c.js";import{d as n,c as p,o}from"./index-BhiDRdjU.js";const c=`<h2 id="安装">安装<a class="doc-anchor" href="#安装">#</a></h2>
...
</div><h4 id="安装sard-uniapp">安装 sard-uniapp<a class="doc-anchor" href="#安装sard-uniapp">#</a></h4>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>scss<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
  <span class="token atrule"><span class="token rule">@use</span> <span class="token string">'sard-uniapp/index.scss'</span><span class="token punctuation">;</span></span>
...
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token comment">&lt;!-- App.vue --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>scss<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
  <span class="token atrule"><span class="token rule">@use</span> <span class="token string">'@/uni_modules/sard-uniapp/index.scss'</span><span class="token punctuation">;</span></span>
</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span>
</code></pre>
...
</div>`,r=n({__name:"quickstart",setup(e){const s={nav:"指引",title:"快速上手",order:1,group:{title:"基础"}};return(t,l)=>(o(),p(a,{content:c,fm:s}))}});export{r as default};
