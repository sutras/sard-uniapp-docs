import{M as s}from"./index-NOufRIAH.js";import{d as n,c as t,o as p}from"./index-C48puoM7.js";const c=`<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>用图片、图标或字符等来展示头像、群、库等事物信息。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Avatar <span class="token keyword">from</span> <span class="token string">'sard-uniapp/components/avatar/avatar.vue'</span>
</code></pre>
...
</div><h3 id="图片类型">图片类型<a class="doc-anchor" href="#图片类型">#</a></h3>
<p>设置 <code>src</code> 图片路径将展示一个完全覆盖框框的图片。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-avatar</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>https://fastly.jsdelivr.net/npm/@sard/assets/pic1.jpg<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre>
...
</div><h3 id="额外内容">额外内容<a class="doc-anchor" href="#额外内容">#</a></h3>
<p><code>extra</code> 属性可以展示例如徽标等组件。要使徽标固定在圆角形状头像右上角边上可以使用 <code>14.6447%</code> 的固定值。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-avatar</span> <span class="token attr-name">shape</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>square<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
</table></div><h3 id="AvatarSlots">AvatarSlots<a class="doc-anchor" href="#AvatarSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</div>`,k=n({__name:"README",setup(o){const a={nav:"组件",title:"Avatar",subtitle:"头像",group:"数据展示"};return(e,l)=>(p(),t(s,{content:c,fm:a}))}});export{k as default};
