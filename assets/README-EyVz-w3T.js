...
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-list</span> <span class="token attr-name">card</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-list-item</span><span class="token punctuation">></span></span>
      <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-picker</span> <span class="token attr-name">v-model</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>value<span class="token punctuation">"</span></span> <span class="token attr-name">:columns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>columns<span class="token punctuation">"</span></span> <span class="token attr-name">@change</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>onChange<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>sar-list-item</span><span class="token punctuation">></span></span>
...
</div><h3 id="对象类型">对象类型<a class="doc-anchor" href="#对象类型">#</a></h3>
...
</div><h3 id="多列">多列<a class="doc-anchor" href="#多列">#</a></h3>
...
</div><h3 id="对象类型多列">对象类型多列<a class="doc-anchor" href="#对象类型多列">#</a></h3>
...
</div><h3 id="级联选择">级联选择<a class="doc-anchor" href="#级联选择">#</a></h3>
...
</table></div><h3 id="PickerEmits">PickerEmits<a class="doc-anchor" href="#PickerEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div><h3 id="PickerOption">PickerOption<a class="doc-anchor" href="#PickerOption">#</a></h3>
...
</div><h3 id="PickerOptionKeys">PickerOptionKeys<a class="doc-anchor" href="#PickerOptionKeys">#</a></h3>
...
</div>`,i=n({__name:"README",setup(e){const a={nav:"组件",title:"Picker",subtitle:"选择器",group:"表单组件"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{i as default};
