...
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Button <span class="token keyword">from</span> <span class="token string">'sard-uniapp/components/loading/loading.vue'</span>
</code></pre>
...
</div><h3 id="加载类型">加载类型<a class="doc-anchor" href="#加载类型">#</a></h3>
...
</div><h3 id="加载文案">加载文案<a class="doc-anchor" href="#加载文案">#</a></h3>
...
</div><h3 id="垂直排布">垂直排布<a class="doc-anchor" href="#垂直排布">#</a></h3>
...
</div><h3 id="加载尺寸">加载尺寸<a class="doc-anchor" href="#加载尺寸">#</a></h3>
...
<p>通过 <code>circular</code> 插槽可以自定义加载图标。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</table></div><h3 id="LoadingSlots">LoadingSlots<a class="doc-anchor" href="#LoadingSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
<tr>
<td>circular</td>
<td>自定义 <code>circular</code> 类型的图标</td>
<td>-</td>
</tr>
</tbody>
...
<div class="doc-code-wrapper"><pre class="language-scss"><code class="language-scss"><span class="token selector">page </span><span class="token punctuation">&#123;</span>
  ...
  <span class="token property">--sar-loading-scale-width</span><span class="token punctuation">:</span> 9.38%<span class="token punctuation">;</span>
  <span class="token property">--sar-loading-scale-min-width</span><span class="token punctuation">:</span> 2px<span class="token punctuation">;</span>
  <span class="token property">--sar-loading-scale-scale-x</span><span class="token punctuation">:</span> 0.75<span class="token punctuation">;</span>
...
</div>`,r=n({__name:"README",setup(c){const a={nav:"组件",title:"Loading",subtitle:"加载",group:"反馈组件"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{r as default};
