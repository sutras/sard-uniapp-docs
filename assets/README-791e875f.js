import{u as a}from"./useCodeTool-bcffc59d.js";import{d as t,c as s,o as n}from"./index-28a3fb09.js";const p=`<h1 id="DatetimePickerInput日期时间输入框">DatetimePickerInput 日期时间输入框<a class="doc-anchor" href="#DatetimePickerInput日期时间输入框">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>组合了日期时间、弹出框、输入框组件，实现了便捷快速的日期选择功能。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> DatetimePickerInput <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/datetime-picker-input/datetime-picker-input.vue'</span>
</code></pre></div>
