import{u as a}from"./useCodeTool-5abdc725.js";import{d as s,c as n,o as t}from"./index-da6ae011.js";const p=`<h1 id="DatetimePicker日期时间选择器">DatetimePicker 日期时间选择器<a class="doc-anchor" href="#DatetimePicker日期时间选择器">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>用于选择日期时间。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> DatetimePicker <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/datetime-picker/datetime-picker.vue'</span>
</code></pre></div>
...
<td>formatter</td>
<td>选项的格式化函数</td>
<td>(letter: DatetimeLetter, option: DatetimeColumnOption, date: Date, index: number) =&gt; string | void</td>
<td>-</td>
</tr>
</tbody>
</table></div>
