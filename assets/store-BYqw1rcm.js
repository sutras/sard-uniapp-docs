import{_ as c,c as u,w as t,r as o,o as l,a as k,b as n,d as s}from"./index-AqI0r-Dh.js";const i={};function r(d,a){const e=o("SCMarkdown"),p=o("SCFrontMatterProvider");return l(),u(p,{"front-matter":"%7B%22nav%22%3A%22%E5%B7%A5%E5%85%B7%22%2C%22title%22%3A%22%E5%85%A8%E5%B1%80%E7%8A%B6%E6%80%81%22%2C%22group%22%3A%7B%22title%22%3A%22%E5%B7%A5%E7%A8%8B%E5%8C%96%22%7D%7D"},{default:t(()=>[k(e,null,{default:t(()=>a[0]||(a[0]=[n("h2",{id:"介绍"},[s("介绍"),n("a",{class:"sc-anchor",href:"#介绍"},"#")],-1),n("p",null,"全局状态存储库允许你跨页面、跨组件共享状态。",-1),n("p",null,[s("下面演示如何使用 "),n("code",null,"pinia"),s(" 以及编写持久化全局状态插件。")],-1),n("h2",{id:"安装pinia"},[s("安装 pinia"),n("a",{class:"sc-anchor",href:"#安装pinia"},"#")],-1),n("div",{class:"sc-code-wrapper"},[n("pre",{class:"language-bash"},[n("code",{class:"language-bash"},[n("span",{class:"token function"},"npm"),s(),n("span",{class:"token function"},"install"),s(` pinia@2
`)])])],-1),n("p",null,[s("必须安装 "),n("code",null,"pinia@2"),s(" 版本，更高版本不支持。")],-1),n("h2",{id:"创建pinia实例并注册"},[s("创建 pinia 实例并注册"),n("a",{class:"sc-anchor",href:"#创建pinia实例并注册"},"#")],-1),n("div",{class:"sc-code-wrapper"},[n("pre",{class:"language-ts"},[n("code",{class:"language-ts"},[n("span",{class:"token comment"},"// @/stores/index.ts"),s(`
...
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token keyword"},"type"),s(),n("span",{class:"token punctuation"},"{"),s(" App "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'vue'"),s(`

`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"const"),s(" pinia "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token function"},"createPinia"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(`

`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"function"),s(),n("span",{class:"token function"},"setupPinia"),n("span",{class:"token punctuation"},"("),s("app"),n("span",{class:"token operator"},":"),s(" App"),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
...
`),n("span",{class:"token comment"},"// @/main.ts"),s(`
...
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" setupPinia "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'@/stores'"),s(`
...
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"function"),s(),n("span",{class:"token function"},"createApp"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token function"},"setupPinia"),n("span",{class:"token punctuation"},"("),s("app"),n("span",{class:"token punctuation"},")"),s(`
...
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"const"),s(" useUserStore "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token function"},"defineStore"),n("span",{class:"token punctuation"},"("),s(`
  ...
  `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),s(`
`),n("span",{class:"token punctuation"},")"),s(`
`)])])],-1),n("p",null,[s("如上，在 "),n("code",null,"defineStore"),s(" 第三个参数的选项对象中，"),n("code",null,"persist.pick"),s(" 数组中声明的状态就是要持久化处理的。")],-1),n("p",null,"在应用启动阶段，会读取硬盘中的状态并初始化；状态值改变时，会保存到硬盘中。",-1)])),_:1})]),_:1})}const w=c(i,[["render",r]]);export{w as default};
