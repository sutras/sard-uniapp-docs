...
</div><h3 id="不同状态的值">不同状态的值<a class="doc-anchor" href="#不同状态的值">#</a></h3>
...
</div><h3 id="加载状态">加载状态<a class="doc-anchor" href="#加载状态">#</a></h3>
...
</table></div><h3 id="SwitchEmits">SwitchEmits<a class="doc-anchor" href="#SwitchEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,r=n({__name:"README",setup(c){const a={nav:"组件",title:"Switch",subtitle:"开关",group:"表单组件"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{r as default};
