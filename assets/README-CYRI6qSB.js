...
</div><h3 id="自定义描述信息">自定义描述信息<a class="doc-anchor" href="#自定义描述信息">#</a></h3>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
</div><h3 id="自定义图标大小">自定义图标大小<a class="doc-anchor" href="#自定义图标大小">#</a></h3>
...
</table></div><h3 id="EmptySlots">EmptySlots<a class="doc-anchor" href="#EmptySlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</div>`,d=n({__name:"README",setup(c){const a={nav:"组件",title:"Empty",subtitle:"空状态",group:"数据展示"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{d as default};
