import{u as a}from"./useCodeTool-5abdc725.js";import{d as s,c as n,o as t}from"./index-da6ae011.js";const p=`<h1 id="Skeleton骨架屏">Skeleton 骨架屏<a class="doc-anchor" href="#Skeleton骨架屏">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>在内容加载过程中提供一组占位图形，通常图形会描述内容的概要排版。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Skeleton <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/skeleton/skeleton.vue'</span>
<span class="token keyword">import</span> SkeletonBlock <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/skeleton-block/skeleton-block.vue'</span>
<span class="token keyword">import</span> SkeletonAvatar <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/skeleton-avatar/skeleton-avatar.vue'</span>
<span class="token keyword">import</span> SkeletonTitle <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/skeleton-title/skeleton-title.vue'</span>
<span class="token keyword">import</span> SkeletonParagraph <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/skeleton-paragraph/skeleton-paragraph.vue'</span>
</code></pre></div>
