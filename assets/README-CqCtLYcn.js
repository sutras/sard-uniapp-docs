...
<p>继承 <a href="./#/components/radio#RadioGroupProps"><code>RadioGroupProps</code></a> 并有以下额外属性：</p>
...
</div>`,r=n({__name:"README",setup(e){const a={nav:"组件",title:"RadioInput",subtitle:"单选输入框",group:"表单组件",version:"1.3+"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{r as default};
