...
</div>`,k=s({__name:"README",setup(e){const a={nav:"组件",title:"CheckboxInput",subtitle:"复选输入框",group:"表单组件",version:"1.3+"};return(c,l)=>(p(),t(n,{content:o,fm:a}))}});export{k as default};
