...
<p>继承 <a href="./checkbox#CheckboxGroupProps"><code>CheckboxGroupProps</code></a> 并有以下额外属性：</p>
...
</table></div><h3 id="CheckboxInputEmits">CheckboxInputEmits<a class="doc-anchor" href="#CheckboxInputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,i=s({__name:"README",setup(e){const a={nav:"组件",title:"CheckboxInput",subtitle:"复选输入框",group:"表单组件",version:"1.3+"};return(c,l)=>(p(),t(n,{content:o,fm:a}))}});export{i as default};
