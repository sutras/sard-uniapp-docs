...
</table></div><h3 id="PopoutInputEmits">PopoutInputEmits<a class="doc-anchor" href="#PopoutInputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,d=n({__name:"README",setup(c){const a={nav:"组件",title:"PopoutInput",subtitle:"弹出式输入框",group:"表单组件"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{d as default};
