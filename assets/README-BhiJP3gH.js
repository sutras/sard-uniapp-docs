...
<p>继承 <a href="./picker#PickerProps"><code>PickerProps</code></a> 并有以下额外属性：</p>
...
</table></div><h3 id="PickerInputEmits">PickerInputEmits<a class="doc-anchor" href="#PickerInputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div>`,k=n({__name:"README",setup(o){const a={nav:"组件",title:"PickerInput",subtitle:"选择器输入框",group:"表单组件"};return(c,l)=>(p(),t(s,{content:e,fm:a}))}});export{k as default};
