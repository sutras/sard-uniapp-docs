...
</div><h3 id="显示省略号">显示省略号<a class="doc-anchor" href="#显示省略号">#</a></h3>
...
</div><h3 id="简单分页">简单分页<a class="doc-anchor" href="#简单分页">#</a></h3>
...
</table></div><h3 id="PaginationSlots">PaginationSlots<a class="doc-anchor" href="#PaginationSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="PaginationEmits">PaginationEmits<a class="doc-anchor" href="#PaginationEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,i=s({__name:"README",setup(e){const a={nav:"组件",title:"Pagination",subtitle:"分页",group:"导航组件"};return(c,l)=>(p(),t(n,{content:o,fm:a}))}});export{i as default};
