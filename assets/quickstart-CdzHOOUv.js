import{M as a}from"./index-CBlzchx7.js";import{d as n,c as p,o}from"./index-qoRthkGm.js";const e=`<h2 id="安装">安装<a class="doc-anchor" href="#安装">#</a></h2>
<p><code>sard-uniapp</code> 支持通过命令行以及插件市场导入 <code>HBuilderX</code> 的方式安装。</p>
...
</div><div class="doc-alert doc-alert-info">
  <div class="doc-alert-title">
    <i class="doc-alert-icon hsi hsi-chat-right-text"></i>
    提示
  </div>
  <div class="doc-alert-content">
<p>为了消除可能的控制台警告信息，可以安装 <code>sass@1.69.7</code> 及以下版本。</p>
<div class="doc-code-wrapper"><pre class="language-bash"><code class="language-bash">Deprecation Warning <span class="token punctuation">[</span>import<span class="token punctuation">]</span>: Sass @import rules are deprecated and will be removed <span class="token keyword">in</span> Dart Sass <span class="token number">3.0</span>.0.
</code></pre>
</div><div class="doc-code-wrapper"><pre class="language-bash"><code class="language-bash">DEPRECATION WARNING: The legacy JS API is deprecated and will be removed <span class="token keyword">in</span> Dart Sass <span class="token number">2.0</span>.0.
</code></pre>
</div>  </div>
</div>
...
</div><h3 id="HBuilderX">HBuilderX<a class="doc-anchor" href="#HBuilderX">#</a></h3>
<h4 id="安装sass_1">安装 sass<a class="doc-anchor" href="#安装sass_1">#</a></h4>
<p><code>HBuilderX</code> 内置了 <code>sass</code> 插件。</p>
...
<h3 id="vite">vite<a class="doc-anchor" href="#vite">#</a></h3>
<p>在 web 开发环境使用 <code>sard-uniapp</code> 时，为避免 <code>vite</code> 依赖预构建缓存 <code>sard-uniapp</code> 部分文件导致出现问题，
需要在预构建中强制排除对 <code>sard-uniapp</code> 的依赖。</p>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token comment">// vite.config.ts</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token function">defineConfig</span><span class="token punctuation">(</span><span class="token punctuation">&#123;</span>
  optimizeDeps<span class="token operator">:</span> <span class="token punctuation">&#123;</span>
    exclude<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">'sard-uniapp'</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">,</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
</code></pre>
</div><h3 id="配置easycom">配置 easycom<a class="doc-anchor" href="#配置easycom">#</a></h3>
<p>建议使用 <code>easycom</code> 来简化组件的引入和注册。</p>
<h4 id="NPM_1">NPM<a class="doc-anchor" href="#NPM_1">#</a></h4>
<div class="doc-code-wrapper"><pre class="language-json"><code class="language-json"><span class="token comment">// pages.json</span>
...
</div><h4 id="HBuilderX_1">HBuilderX<a class="doc-anchor" href="#HBuilderX_1">#</a></h4>
...
</div><h3 id="配置全局组件类型">配置全局组件类型<a class="doc-anchor" href="#配置全局组件类型">#</a></h3>
<p>在 <code>vscode</code> 中使用时，为了有组件的类型提示和自动填充，需要配置全局组件类型声明。</p>
<div class="doc-code-wrapper"><pre class="language-json"><code class="language-json"><span class="token comment">// tsconfig.json</span>
<span class="token punctuation">&#123;</span>
...
</div><p>如果是使用 <code>WebStorm</code>，则需要在 <code>main.ts</code> 文件中导入 <code>global.d.ts</code> 文件。</p>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token comment">// main.ts</span>
<span class="token keyword">import</span> 'sard<span class="token operator">-</span>uniapp<span class="token operator">/</span>global<span class="token punctuation">.</span>d<span class="token punctuation">.</span>ts
</code></pre>
</div><h3 id="配置mp-alipay端样式隔离方式">配置 <code>mp-alipay</code> 端样式隔离方式<a class="doc-anchor" href="#配置mp-alipay端样式隔离方式">#</a></h3>
<p><code>sard-uniapp</code> 组件样式隔离方式需要设置为 <code>shared</code>，默认情况下，<code>uniapp</code> 编译到 <code>mp-alipay</code> 时并不会在组件配置文件中设置 <code>&quot;styleIsolation&quot;: &quot;shared&quot;</code>，而是需要在 <code>manifest.json</code> 文件中进行配置：</p>
<div class="doc-code-wrapper"><pre class="language-json"><code class="language-json"><span class="token comment">// manifest.json</span>
<span class="token punctuation">&#123;</span>
  <span class="token property">"mp-alipay"</span><span class="token operator">:</span> <span class="token punctuation">&#123;</span>
    <span class="token property">"styleIsolation"</span><span class="token operator">:</span> <span class="token string">"shared"</span>
  <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span>
</code></pre>
</div><h2 id="引入全局样式">引入全局样式<a class="doc-anchor" href="#引入全局样式">#</a></h2>
...
</div><h3 id="HBuilderX_1_1">HBuilderX<a class="doc-anchor" href="#HBuilderX_1_1">#</a></h3>
<p>如果你是通过插件市场导入到 <code>HBuilderX</code> 的，需要修改引入路径：</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token comment">&lt;!-- App.vue --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>scss<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token style"><span class="token language-css">
...
</div>`,u=n({__name:"quickstart",setup(c){const s={nav:"指引",title:"快速上手",order:1,group:{title:"基础"}};return(t,l)=>(o(),p(a,{content:e,fm:s}))}});export{u as default};
