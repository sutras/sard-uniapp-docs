...
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-password-input</span> <span class="token attr-name">v-model</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>value<span class="token punctuation">"</span></span> <span class="token attr-name">@change</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>onChange<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
...
</div><h3 id="下划线类型">下划线类型<a class="doc-anchor" href="#下划线类型">#</a></h3>
...
</div><h3 id="间距">间距<a class="doc-anchor" href="#间距">#</a></h3>
...
</div><h3 id="明文显示">明文显示<a class="doc-anchor" href="#明文显示">#</a></h3>
...
</div><h3 id="使用自定义键盘">使用自定义键盘<a class="doc-anchor" href="#使用自定义键盘">#</a></h3>
...
</table></div><h3 id="PasswordInputEmits">PasswordInputEmits<a class="doc-anchor" href="#PasswordInputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</div>`,k=n({__name:"README",setup(e){const a={nav:"组件",title:"PasswordInput",subtitle:"密码输入框",group:"表单组件"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{k as default};
