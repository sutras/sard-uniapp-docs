import{u as a}from"./useCodeTool-5abdc725.js";import{d as s,c as n,o as t}from"./index-da6ae011.js";const p=`<h1 id="Icon图标">Icon 图标<a class="doc-anchor" href="#Icon图标">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>基于字体的图标集。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Icon <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/icon/icon.vue'</span>
</code></pre></div>
...
<p>下面演示如何引入 <a href="https://www.iconfont.cn/" target="_blank"><code>iconfont</code></a> 中的图标库（以此文档案例使用的<code>demo-icons</code>图标库演示）：</p>
<ol>
<li>
...
<li>
<p>我们只需要得到解压后的以下两个文件:</p>
<ul>
<li><code>iconfont.css</code></li>
<li><code>iconfont.ttf</code></li>
</ul>
</li>
<li>
<p>将<code>iconfont.ttf</code>文件复制到<code>src/static</code>目录；</p>
</li>
<li>
<p>将<code>iconfont.css</code>文件复制到<code>src</code>目录；</p>
</li>
<li>
<p>修改<code>iconfont.css</code>文件中字体的引入路径；</p>
</li>
<li>
<p>在<code>App.vue</code>文件导入<code>iconfont.css</code>文件:</p>
<div class="doc-code-wrapper"><pre class="language-scss"><code class="language-scss"><span class="token keyword">@use</span> <span class="token string">'./iconfont.css'</span><span class="token punctuation">;</span>
</code></pre></div>
</li>
<li>
...
`,u=s({__name:"README",setup(c){return a(),(o,e)=>(t(),n("div",{class:"doc-content",innerHTML:p}))}});export{u as default};
