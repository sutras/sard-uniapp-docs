...
<p>继承 <a href="./cascader#CascaderProps"><code>CascaderProps</code></a> 并有以下额外属性：</p>
...
</table></div><h3 id="CascaderInputSlots">CascaderInputSlots<a class="doc-anchor" href="#CascaderInputSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="CascaderInputEmits">CascaderInputEmits<a class="doc-anchor" href="#CascaderInputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div>`,d=n({__name:"README",setup(e){const a={nav:"组件",title:"CascaderInput",subtitle:"级联输入框",group:"表单组件"};return(c,l)=>(p(),t(s,{content:o,fm:a}))}});export{d as default};
