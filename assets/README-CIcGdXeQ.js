...
</div>`,i=n({__name:"README",setup(o){const a={nav:"组件",title:"DatetimeRangePicker",subtitle:"日期时间范围选择器",group:"表单组件",version:"1.11+"};return(c,l)=>(p(),t(s,{content:e,fm:a}))}});export{i as default};
