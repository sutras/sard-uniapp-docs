import{M as n}from"./index-D9Z88DAz.js";import{d as s,c as t,o as p}from"./index-CA2jsFMw.js";const e=`<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>组合了日期时间范围、弹出框、输入框组件，实现了便捷快速的日期时间范围选择功能。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> DatetimeRangePickerInput <span class="token keyword">from</span> <span class="token string">'sard-uniapp/components/datetime-range-picker-input/datetime-range-picker-input.vue'</span>
</code></pre>
</div><h2 id="代码演示">代码演示<a class="doc-anchor" href="#代码演示">#</a></h2>
<h3 id="基础使用">基础使用<a class="doc-anchor" href="#基础使用">#</a></h3>
<p>和 <code>DatetimePickerInput</code> 组件用法类似，多了一个 <code>tabs</code> 属性设置起始和结束标签页标题。</p>
...
<span class="token keyword">const</span> date <span class="token operator">=</span> ref<span class="token operator">&lt;</span>string<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token operator">></span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<h3 id="DatetimeRangePickerInputProps">DatetimeRangePickerInputProps<a class="doc-anchor" href="#DatetimeRangePickerInputProps">#</a></h3>
<p>继承 <a href="./datetime-range-picker#DatetimeRangePickerProps"><code>DatetimeRangePickerProps</code></a> 并有以下额外属性：</p>
...
</table></div><h3 id="DatetimeRangePickerInputEmits">DatetimeRangePickerInputEmits<a class="doc-anchor" href="#DatetimeRangePickerInputEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div>`,i=s({__name:"README",setup(o){const a={nav:"组件",title:"DatetimeRangePickerInput",subtitle:"日期时间范围输入框",group:"表单组件",version:"1.11+"};return(c,l)=>(p(),t(n,{content:e,fm:a}))}});export{i as default};
