import{u as n}from"./useCodeTool-bcffc59d.js";import{d as s,c as a,o as t}from"./index-28a3fb09.js";const p=`<h1 id="Indexes索引">Indexes 索引<a class="doc-anchor" href="#Indexes索引">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>用于页面中信息快速检索，可以根据目录中的页码快速找到所需的内容。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Indexes <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/indexes/indexes.vue'</span>
<span class="token keyword">import</span> IndexesAnchor <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/indexes-anchor/indexes-anchor.vue'</span>
</code></pre></div>
