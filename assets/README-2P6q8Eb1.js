...
</div><p>接着便可以使用 <code>toast</code> 等方法显示提示。</p>
...
</div><h3 id="加载中的背景">加载中的背景<a class="doc-anchor" href="#加载中的背景">#</a></h3>
...
</table></div><h3 id="ToastEmits">ToastEmits<a class="doc-anchor" href="#ToastEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div><h3 id="ToastAgentPropsToastOptions">ToastAgentProps / ToastOptions<a class="doc-anchor" href="#ToastAgentPropsToastOptions">#</a></h3>
...
</table></div><h3 id="ToastFunction">ToastFunction<a class="doc-anchor" href="#ToastFunction">#</a></h3>
...
</div><h3 id="ToastSimpleShowFunction">ToastSimpleShowFunction<a class="doc-anchor" href="#ToastSimpleShowFunction">#</a></h3>
...
</div>`,i=n({__name:"README",setup(c){const a={nav:"组件",title:"Toast",subtitle:"轻提示",group:"反馈组件"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{i as default};
