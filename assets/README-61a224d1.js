import{u as a}from"./useCodeTool-5abdc725.js";import{d as s,c as t,o as n}from"./index-da6ae011.js";const p=`<h1 id="Overlay遮罩层">Overlay 遮罩层<a class="doc-anchor" href="#Overlay遮罩层">#</a></h1>
<h2 id="介绍">介绍<a class="doc-anchor" href="#介绍">#</a></h2>
<p>创建一个遮罩层，用于强调特定的页面元素，并阻止用户进行其他操作。</p>
<h2 id="引入">引入<a class="doc-anchor" href="#引入">#</a></h2>
<div class="doc-code-wrapper"><pre class="language-ts"><code class="language-ts"><span class="token keyword">import</span> Overlay <span class="token keyword">from</span> <span class="token string">'@sard/uniapp/dist/overlay/overlay.vue'</span>
</code></pre></div>
