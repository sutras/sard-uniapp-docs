...
<p><code>NoticeBar</code> 组件是通过 <code>animation</code> 来实现高效的滚动动画的，
会根据内容宽度动态设置动画时长，以实现固定速率滚动。</p>
<p>如果 <code>NoticeBar</code> 挂载时机比插槽内容靠前，即插槽内容数据需要通过接口异步获取再渲染的，
需要手动调用 <code>update</code> 方法来更新动画时长。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-notice-bar</span> <span class="token attr-name">ref</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>noticeBarRef<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    &#123;&#123; text &#125;&#125;
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>sar-notice-bar</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
...
<span class="token keyword">const</span> noticeBarRef <span class="token operator">=</span> <span class="token function">ref</span><span class="token punctuation">(</span><span class="token punctuation">)</span>

<span class="token function">setTimeout</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
  text<span class="token punctuation">.</span>value <span class="token operator">=</span> <span class="token string">'这是一条很长很长很长很长很长很长很长很长很长很长的公告！'</span>
  <span class="token function">nextTick</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
    noticeBarRef<span class="token punctuation">.</span>value<span class="token punctuation">.</span><span class="token function">update</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span>
<span class="token punctuation">&#125;</span><span class="token punctuation">,</span> <span class="token number">1500</span><span class="token punctuation">)</span>
</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>
</code></pre>
</div><h3 id="强制滚动">强制滚动<a class="doc-anchor" href="#强制滚动">#</a></h3>
...
</div><h3 id="强制不滚动">强制不滚动<a class="doc-anchor" href="#强制不滚动">#</a></h3>
...
</div><h3 id="多行展示">多行展示<a class="doc-anchor" href="#多行展示">#</a></h3>
...
</div><h3 id="自定义左边图标">自定义左边图标<a class="doc-anchor" href="#自定义左边图标">#</a></h3>
...
</div><h3 id="可链接的">可链接的<a class="doc-anchor" href="#可链接的">#</a></h3>
...
</div><h3 id="自定义右边图标">自定义右边图标<a class="doc-anchor" href="#自定义右边图标">#</a></h3>
...
</div><h3 id="垂直滚动">垂直滚动<a class="doc-anchor" href="#垂直滚动">#</a></h3>
...
</table></div><h3 id="NoticeBarSlots">NoticeBarSlots<a class="doc-anchor" href="#NoticeBarSlots">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>插槽</th>
<th>描述</th>
...
</table></div><h3 id="NoticeBarEmits">NoticeBarEmits<a class="doc-anchor" href="#NoticeBarEmits">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>事件</th>
<th>描述</th>
...
</table></div><h3 id="NoticeBarExpose">NoticeBarExpose<a class="doc-anchor" href="#NoticeBarExpose">#</a></h3>
<div class="doc-table-responsive"><table><thead>
<tr>
<th>属性</th>
<th>描述</th>
...
</div>`,i=n({__name:"README",setup(c){const a={nav:"组件",title:"NoticeBar",subtitle:"公告栏",group:"数据展示"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{i as default};
