...
</div><p>接着便可以使用 <code>notify</code> 等方法显示提示。</p>
...
</div><h3 id="自定义时长">自定义时长<a class="doc-anchor" href="#自定义时长">#</a></h3>
<p><code>timeout</code> 设为 0 后会一直显示。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-list</span> <span class="token attr-name">card</span><span class="token punctuation">></span></span>
...
</div><h3 id="自定义位置">自定义位置<a class="doc-anchor" href="#自定义位置">#</a></h3>
<p>通知允许在屏幕上边或下边展示。</p>
<div class="doc-code-wrapper"><pre class="language-html"><code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>sar-list</span> <span class="token attr-name">card</span><span class="token punctuation">></span></span>
...
<td>是否包含状态栏，自定义导航栏时应设为 <code>true</code></td>
<td>boolean</td>
<td>false</td>
</tr>
</tbody>
</table></div><h3 id="NotifyAgentPropsNotifyOptions">NotifyAgentProps / NotifyOptions<a class="doc-anchor" href="#NotifyAgentPropsNotifyOptions">#</a></h3>
...
</table></div><h3 id="NotifyFunction">NotifyFunction<a class="doc-anchor" href="#NotifyFunction">#</a></h3>
...
</div><h3 id="NotifySimpleShowFunction">NotifySimpleShowFunction<a class="doc-anchor" href="#NotifySimpleShowFunction">#</a></h3>
...
</div>`,k=n({__name:"README",setup(c){const a={nav:"组件",title:"Notify",subtitle:"消息通知",group:"反馈组件"};return(e,l)=>(p(),t(s,{content:o,fm:a}))}});export{k as default};
